  ...
  function getCalendar(target_div, year, month,type)
        { 
         alert(target_div+ " "+year+" "+month+" "+type);
            $.ajax({ 
                type:'POST', 
                url:'http://mobileandwebsitedevelopment.com/fivepercent/includes/dbConfig.php', 
  ...
  function getCalendarCommon(target_div, year, month)
        { 
         // alert();
            $.ajax({ 
                type:'POST', 
                url:'http://mobileandwebsitedevelopment.com/fivepercent/includes/calender-functions.php', 
