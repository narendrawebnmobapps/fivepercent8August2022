...
<!--   <script type="text/javascript" src="https://mobileandwebsitedevelopment.com/fivepercent/cdntesting/1.js"></script> -->
...
<body>
  ...
  <section class="header-top-prt">
    <div class="container">
      <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-6 header-top-contacts-info">
         <!--  <i class="fa fa-map-marker"></i>
          <p>Uttarkhan, Noyarpara</p> -->

          <i class="fa fa-envelope-o"></i>
          <p><a href="mailto:Yourdomain@Gmail.Com">Yourdomain@Gmail.Com</a></p>

          <i class="fa fa-phone" aria-hidden="true"></i>
          <p><a href="tel:875621456987">875621456987</a></p>
        </div>
        <?php  
        ...
        ?>
        <div class="col-lg-5 col-md-5 col-sm-6 header-top-login-btns">
