...
<div class="page-breadcrumb">
	<div class="row">
	    <div class="col-12 d-flex no-block align-items-center">
	        <h4 class="page-title">User Test Question</h4>
              									...
              									<nav class="navbar navbar-expand-lg navbar-light bg-light">
              									    ...
              									    <ul class="navbar-nav">
              									      <li class="nav-item active">
              									        <a class="nav-link" href="<?php echo base_url('admin/test/add_user_test') ?>">Add Test Question</a>
              									      </li>
              									  	</ul>
              									   </div>
              									</nav>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(71px, 35px, 0px);">
                                                            <a class="dropdown-item" href="<?php echo base_url('admin/test/edit_user_test/').$question['id']; ?>">Edit</a>
                                                            <a class="dropdown-item" href="<?php echo base_url('admin/test/delete_user_test/').$question['id']; ?>">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
