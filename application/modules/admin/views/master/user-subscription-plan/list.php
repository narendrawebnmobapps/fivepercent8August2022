            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
									...
									<nav class="navbar navbar-expand-lg navbar-light bg-light">
									    ...
									    <ul class="navbar-nav">
									      <li class="nav-item active">
									        <a class="nav-link" href="<?php echo base_url('admin/master/add_subscription_plan') ?>">Add Plan</a>
									      </li>
									  	</ul>
									   </div>
									</nav>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">User Subscription Plan</h5>                               
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(71px, 35px, 0px);">
                                                            <a class="dropdown-item" href="<?php  echo base_url('admin/master/edit_subscription_plan/').$subscription['id']; ?>">Edit</a>
