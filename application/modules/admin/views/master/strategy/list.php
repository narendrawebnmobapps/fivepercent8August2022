...
<div class="page-breadcrumb">
	<div class="row">
	    <div class="col-12 d-flex no-block align-items-center">
	        <h4 class="page-title">Strategy</h4>
									...
									<nav class="navbar navbar-expand-lg navbar-light bg-light">
									    ...
									    <ul class="navbar-nav">
									      <li class="nav-item active">
									        <a class="nav-link" href="<?php echo base_url('admin/master/add_strategy') ?>">Add Strategy</a>
									      </li>
									  	</ul>
									   </div>
									</nav>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php if(count($strategies)>0): $inc = 1; foreach($strategies as $strategy): ?>
                                            <tr>
                                                <td><?php echo $inc; ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(71px, 35px, 0px);">
                                                            <a class="dropdown-item" href="<?php  echo base_url('admin/master/edit_strategy/').$strategy->id; ?>">Edit</a>
                                                            <a class="dropdown-item" href="<?php  echo base_url('admin/master/delete_strategy/').$strategy->id; ?>">Delete</a>
                                                        </div>
                                                    </div>
