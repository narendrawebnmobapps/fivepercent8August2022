...
<div class="page-breadcrumb">
	<div class="row">
	    <div class="col-12 d-flex no-block align-items-center">
	        <h4 class="page-title">Live News</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
									...
									<nav class="navbar navbar-expand-lg navbar-light bg-light">
									    ...
									    <ul class="navbar-nav">
									      <li class="nav-item active">
									        <a class="nav-link" href="<?php echo base_url('admin/master/add_live_news') ?>">Add Live News</a>
									      </li>
									  	</ul>
									   </div>
									</nav>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Live News</h5>                               
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php if(count($live_news)>0): $inc = 1; foreach($live_news as $news): ?>
                                            <tr>
                                                <td><?php echo $inc; ?></td>
                                                <td>
                                                    <?php if($news->section==0){echo "User";} else {echo "Advisor";} ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(71px, 35px, 0px);">
                                                            <a class="dropdown-item" href="<?php  echo base_url('admin/master/edit_live_news/').$news->id; ?>">Edit</a>
                                                            <a class="dropdown-item" href="<?php  echo base_url('admin/master/delete_live_news/').$news->id; ?>">Delete</a>
                                                        </div>
                                                    </div>
