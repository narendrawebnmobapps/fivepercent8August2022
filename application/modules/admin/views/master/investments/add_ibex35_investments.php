...
<div class="page-breadcrumb">
	<div class="row">
	    <div class="col-12 d-flex no-block align-items-center">
	        <h4 class="page-title">Add IBEX35  Investment Funds</h4>
	        <div class="ml-auto text-right">
	            <nav aria-label="breadcrumb">
	                <ol class="breadcrumb">
	                    <li class="breadcrumb-item"><a href="#">Home</a></li>
	                    <li class="breadcrumb-item active" aria-current="page">Add IBEX35  Investment Funds</li>
	                </ol>
	            </nav>
	        </div>
	    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" name="fund_commission" class="form-control fund_commission" required>
                        </div>
                         <div class="form-group">
                          <label for="sel1">Fund Type</label>
                        <!--   <input type="text" name="fund_type" class="form-control" required> -->
                          <select  type="select" name="fund_type" class="form-control" required>
                            <option value="Conservative funds">Conservative funds</option>
                            <option value="Moderate funds">Moderate funds</option>
                            <option value="Risky funds">Risky funds</option>
                        ...
                        <div class="form-group">
                         ...
                         <textarea  name="fund_description" class="form-control" required></textarea>
                        </div>
