...
<div class="page-breadcrumb">
	<div class="row">
	    <div class="col-12 d-flex no-block align-items-center">
	        <h4 class="page-title">IBEX35 Investment Funds</h4>
	        <div class="ml-auto text-right">
	            <nav aria-label="breadcrumb">
	                <ol class="breadcrumb">
	                    <li class="breadcrumb-item"><a href="#">Home</a></li>
	                    <li class="breadcrumb-item active" aria-current="page">IBEX35 Investment Funds</li>
	                </ol>
	            </nav>
	        </div>
	    </div>
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                       ...
                                       <ul class="navbar-nav">
                                          <li class="nav-item active">
                                            <a class="nav-link" href="<?php echo base_url('admin/master/add_ibex35_investments') ?>">Add Ibex35 Investment Funds</a>
                                          </li>
                                        </ul> 
                                       </div>
                                    </nav>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php if(count($ibex35_investments)>0): $inc = 1; foreach($ibex35_investments as $fund): ?>
                                            <tr>
                                                <td><?php echo $inc; ?></td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(71px, 35px, 0px);">
                                                            ...
                                                            <a class="dropdown-item" href="<?php  echo base_url('admin/master/edit_investments_ibex35/').$fund->investments_id; ?>">Edit</a>
                                                            <a class="dropdown-item" href="<?php  echo base_url('admin/master/delete_investments_ibex35/').$fund->investments_id; ?>">Delete</a>
