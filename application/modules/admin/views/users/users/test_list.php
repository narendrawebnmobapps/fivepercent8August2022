                    ...
                    <!-- <h3 class="panel-title">Panel title</h3> --> <span class="">
                        <!-- Tabs -->
                         <ul class="nav panel-tabs">
                            <li><a href="<?php  echo base_url('admin/users/users_details/').base64_encode($user_detail->id); ?>">Personal Info</a></li>
                            ...
                            <li  class="active"><a href="<?php echo base_url('admin/users/test_list/').base64_encode($user_detail->id); ?>" >Test List</a></li>
                        </ul>
                    </span>
                  </div>
                      ...
                      <?php } ?>
                       ...
                       <section class="sidebar-setion-pprts-glossery"> 
                               <?php foreach($tests as $test){ 
                                    if($test->answered>0)
                                    {
                                        $url = 'admin/users/test_result/'.base64_encode(base64_encode($user_detail->id)).'/'.base64_encode(base64_encode($test->test_number));
                                    }
                                    else
                                    {
                                        $url = '';
