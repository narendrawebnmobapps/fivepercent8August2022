                    ...
                    <!-- <h3 class="panel-title">Panel title</h3> --> <span class="">
                        <!-- Tabs -->
                         <ul class="nav panel-tabs">
                            ...
                            <li class="active"><a href="<?php echo base_url('admin/users/understandingFinancialcommitment/').base64_encode($user_detail->id); ?>" >Understanding Financial Commitments</a></li>
                            ...
                            <form method="post" action="">
                              ...
                              <div class="post">
                                <div class="col-12 col-md-12 finance-statement-heading-text">
                                 <h3>Understanding Financial Commitments Of The Customber</h3>
                              </div>
                              <?php }                             
                               ?>                             
