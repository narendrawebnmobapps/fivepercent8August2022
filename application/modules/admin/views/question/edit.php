...
<div class="container-fluid">
                ...
                <form method="post" action="<?php echo base_url('admin/questions/edit/').$this->uri->segment(4); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="language" required>
                            ...
                            <option <?php if($questions[0]['question']->lang_id==1){ echo 'selected'; } ?> value="1">English</option>
                            <option <?php if($questions[0]['question']->lang_id==2){ echo 'selected'; } ?> value="2">Spanish</option>
                            <option <?php if($questions[0]['question']->lang_id==3){ echo 'selected'; } ?> value="3">Vietnamese </option>
                          </select>
                        </div>
                        <div class="form-group">
                          ...
                          <select class="form-control" name="question_category" required>
                            ...
                            <option <?php if($questions[0]['question']->question_category==1){ echo 'selected'; } ?> value="1">Financial Situation</option>
                            <option <?php if($questions[0]['question']->question_category==2){ echo 'selected'; } ?> value="2">Investment Objectives</option>
                            <option <?php if($questions[0]['question']->question_category==3){ echo 'selected'; } ?>  value="3">Knowledge & Experience</option>
                            <option <?php if($questions[0]['question']->question_category==4){ echo 'selected'; } ?> value="4">Understanding Fiancial commetements</option>
                          </select>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.input_fields_container').on("click",".remove_field", function(e){ //user click on remove text links
        ...
        //alert(rowid);
        $.ajax({
              url:'<?php echo base_url("admin/questions/remove_question_options"); ?>',
              type:'POST',
              data:{rowid:rowid},
              dataType:'html',
