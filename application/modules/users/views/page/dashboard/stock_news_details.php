                ...
                <div class="col-lg-8 col-sm-8 col-md-8">
                    ...
                    <div class="post-detail-large-thubbs">
                      ...
                      <div class="postmeta-title">
                        ...
                        <?php 
                            $day = date("d", strtotime($news_detail->news_date));
                            $month = date("M", strtotime($news_detail->news_date));
                        ?>
            ...
            <div class="live-news-box-prts">
                ...
                <div class="main-prts">
                    <div class="user-profile">
                        <img src="<?php echo base_url('uploads/news/'.$news->image); ?>" style="height: 65px;">
                    </div>
                    <div class="user-contants">
                        <p><?php echo $news->news_content; ?></p>
                        <h5>New Circle in 2019</h5>
