...
.box-contant-boxe-question {
                    ...
                    <div class="tab-content">
                      ...
                      <?php } ?>
                        <div class="center-profile-box">
                            <form method="post" action="" id="tradingDiaryForm" enctype="multipart/form-data" >
                              <div class="col-md-12 col-sm-12">
                                <label>Date In</label>
                                <div class="form-group">
                                  <input type="text" value="" name="datein" onchange="ValidateEndDate('datepicker_datein')"  id="datepicker_datein" required placeholder="" class="form-control">
                                </div>
                              </div>
                              <div class="col-md-12 col-sm-12">
                                <label>Product</label>
                                <div class="form-group">
                                  <select name="product" required class="form-control">
                                    ...
                                    <option value="<?php echo $pro->id; ?>"><?php echo $pro->stock_name; ?></option>
                                  <?php } ?>
                                  </select>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-group">
                                  <select name="broker" required class="form-control">
                                    ...
                                    <option value="<?php echo $broker['broker_id']; ?>"><?php echo $broker['first_name'].' '.$broker['last_name']; ?></option>
                                  <?php } ?>
                                  </select>
                                </div>
                              </div>
                              <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-group">
                                  <input type="text"   name="pricein" value="" required  class="form-control pricein">
                                </div>
                              </div>
                              <div class="col-md-12 col-sm-12">
                                <label>Initial Volume</label>
                                <div class="form-group">
                                  <input type="text"   name="volume" value="" required  class="form-control initialVolume">
                                </div>
                              </div>
                              <div class="col-md-12 col-sm-12">
                                <label>Date Out</label>
                                <div class="form-group">
                                  <input type="text" value="" name="dateout" onchange="ValidateEndDate('datepicker_dateout')"  id="datepicker_dateout" placeholder="" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-group">
                                  <input type="text"   name="priceout" value=""  class="form-control priceout">
                                </div>
                              </div>
                              <div class="col-md-12 col-sm-12">
                                <label>Final Volume</label>
                                <div class="form-group">
                                  <input type="text"   name="finalvolume" value="" class="form-control finalVolume">
                                </div>
                              </div>
                              <div class="col-md-12 col-sm-12 message-box-fli">
                                <label>Comment</label>
                                <div class="form-group">
                                  <textarea type="message" name="comment" class="form-control"></textarea>
                                </div>
                              </div>
  ...
  <script type="text/javascript">
    /*var testing = false;
    function checkTradingCondition(event)
    {
          event.preventDefault();
          var pricein = $('.pricein').val(); 
          var initialVolume = $('.initialVolume').val(); 
          var priceout = $('.priceout').val(); 
          var finalVolume = $('.finalVolume').val(); 
          $.ajax({
                url:'<?php echo base_url("users/tradingdiary/checkavailablemoneytodd"); ?>',
                method:'POST',
                data:{pricein:pricein,volume:initialVolume,priceout:priceout,finalvolume:finalVolume},
                success:function(data)
                {
                  ...
                  {
                    //alert('submit');
                    //$("#tradingDiaryForm").submit();
                    testing = true;
                    $('#tradingDiaryForm').attr('action', 'https://example.com');
                    $('#tradingDiaryForm').submit();
                    alert(testing);
                  }
                  else if(json['canAdd']==0)
                  {
                    sweetAlert('error','Oops...','You have remaining amount to investment is '+json['remaining']+'. You are exceeding the limit');
                  }
                  else
                  {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(json['canAdd']==1)
                {
                  ...
                  /*$('#tradingDiaryForm').attr('action', 'https://example.com');
                  $('#tradingDiaryForm').submit();*/
                  $form.attr('action', '<?php echo base_url("users/tradingdiary/add_trading_diary"); ?>').off('submit').submit();
                }
                else if(json['canAdd']==0)
                {
                  sweetAlert('error','Oops...','You are exceeding the limit. You have remaining amount to investment is '+json['remaining']+'.');
                }
                else
                {
                  sweetAlert('error','Oops...','Something went wrong');
