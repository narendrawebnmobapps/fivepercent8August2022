                  ...
                  <div class="panel-body">
                    <div class="tab-content">
                      <div class="tab-pane active" id="tab1">
                          ...
                          <div class="col-md-6 col-sm-6 sehedule-spci appoint-list">
                            <h2><a href="<?php echo base_url('users/advisor/appointment_list'); ?>">Appointment List</a></h2>
                        </div>

                        <div class="col-md-6 col-sm-6 sehedule-spci">
                            <h2><a href="<?php echo base_url('users/advisor/add_availability_schedule'); ?>">Schedule Specific Days and Times</a></h2>
                          </div>
