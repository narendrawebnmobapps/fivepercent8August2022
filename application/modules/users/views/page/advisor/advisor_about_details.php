                    ...
                    <!-- <h3 class="panel-title">Panel title</h3> --> <span class="">
                        <!-- Tabs -->
                         <ul class="nav panel-tabs">
                            ...
                            <li class="active"><a href="<?php echo base_url('users/advisor/advisor_about_details'); ?>">About</a></li>
                          ...
                          <form method="post" action="" enctype="multipart/form-data">                            
                            <div class="col-md-12 col-sm-12 message-box-fli">
                              ...
                              <div class="form-group">
                                <textarea type="message" name="aboutYourSelf" class="form-control" required placeholder="About Yourself..."><?php echo @$YourSelf->aboutYourSelf; ?></textarea>
                              </div>
                            </div>                         
