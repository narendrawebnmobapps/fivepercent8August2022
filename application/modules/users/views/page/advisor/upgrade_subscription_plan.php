...
<head>
    ...
    <style type="text/css">
        .basicplanonly {
         ...
         .subcribe-tab-prt .nav>li>a
        {
                padding: 10px 120.3px;
        } 
    </style>
</head>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading"> 
                                        ...
                                        <ul class="nav panel-tabs">
                                            <?php 
                                            if($existing_plan->plan_id==5) { 
                                                $compare= 6;
                                            ?>
                                            <li class="basicplanonly"><a href="#tab1" data-toggle="tab">Basic</a></li>
                                            <li class="active"><a href="#tab2" data-toggle="tab">Premium</a></li>
                                            <?php } ?>                             
                                        </ul>
                                        </span>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="tab-content">
                                            <?php $inc=5; foreach($subscriptions as $subscription) { ?>
