                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                    <div class="panel-body">
                                                        <?php foreach($stock_rvs as $rvs) { ?>
                                                          <input type="checkbox" name="stock_id[]" class="deleteSelected" checkedid="<?php echo $rvs->id; ?>" value="<?php echo $rvs->id; ?>*0*1" <?php if($rvs->exist==1) {echo 'checked'; } ?>> <?php echo $rvs->stock_name; ?> <span><?php echo $rvs->volatility; ?></span><br>
                                  ...
                                  <button class="btn  nocls  adviserbtn <?php if($all_money==1){echo 'btn-default'; } else { echo 'btn-primary'; } ?>" data-id="2">No</button>
                                           ...
                                           <div class="risk-percentage">
                                            ...
                                            <div class="col-md-12 col-sm-12 finish-btn">
                                                ...
                                                <div class="btn-save-info btn-save-info-saved alert alert-success" style="display: none;">
                                                   Data saved Successfully
                                                </div>
                                                <div class="btn-save-info btn-save-info-modification alert alert-success" style="display: none;">
                                                   The system has detected a modification of the portfolio suggestion based on your profile.
                                                </div>
                                            </div>
                                     </form>
                                        </div>
      ...
      $(document).on('click','.rf_rv_money_risk_button',function(event){
            ...
            $.ajax({
                ...
                success:function(data)
                {
                  // console.log(data);
                  //alert(data);
                  $('.btn-save-info-saved').fadeIn('fast').delay(15000).fadeOut('fast');
                  setTimeout(function(){ location.reload(); }, 15000);
                   if(data==1)
                   {
                   // $('.btn-save-info').show();
                    
                   $('.btn-save-info-modification').fadeIn('fast').delay(15000).fadeOut('fast');
