...
<head>
  ...
  <title>Knowlegde & Experience</title>
  <!-- Bootstrap core CSS -->
                    ...
                    <!-- <h3 class="panel-title">Panel title</h3> --> <span class="">
                        <!-- Tabs -->
                         <ul class="nav panel-tabs">
                            ...
                            <li class="KnowlegdeExperience active"><a href="<?php echo base_url('user/knowledge-experience/'.base64_encode(base64_encode($this->session->userdata('user_id')))); ?>">Knowlegde & Experience</a></li>
