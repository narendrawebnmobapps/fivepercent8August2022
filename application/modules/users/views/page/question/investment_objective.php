...
<head>
  ...
  <title>Investment Objectives</title>
  <!-- Bootstrap core CSS -->
                    ...
                    <!-- <h3 class="panel-title">Panel title</h3> --> <span class="">
                        <!-- Tabs -->
                         <ul class="nav panel-tabs">
                            ...
                            <li class="InvestmentObjectives active"><a href="<?php echo base_url('user/investment-objective/'.base64_encode(base64_encode($this->session->userdata('user_id')))); ?>">Investment Objectives</a></li>
