                    ...
                    <!-- <h3 class="panel-title">Panel title</h3> --> <span class="">
                        <!-- Tabs -->
                         <ul class="nav panel-tabs">
                            ...
                            <li class="FinancialSituation active"><a href="<?php echo base_url('user/financial-situation/'.base64_encode(base64_encode($this->session->userdata('user_id')))); ?>">Financial Situation</a></li>
                            ...
                            <form method="post" action="">
                              ...
                              <div class="post">
                                <div class="col-12 col-md-12 finance-statement-heading-text">
                                 <h3>Financial Situation Of The Customer</h3>
                              </div>
                              <?php }                             
                               ?>                             
