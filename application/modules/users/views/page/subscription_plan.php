                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading"> 
                                        ...
                                        <ul class="nav panel-tabs">
                                            ...
                                            <li class="active"><a href="#tab1" data-toggle="tab">Free</a></li>
                                            ...
                                            <li class="basicplanonly"><a href="#tab4" data-toggle="tab">Advanced</a></li>                           
                                        </ul>
                                        </span>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane <?php if($inc==1){ echo 'active'; } ?> " id="tab<?php echo $inc; ?>">
